...
let DoublePendulum = function(m1,l1,a1,m2,l2,a2,center){
...
let pendulum,num,rot,drot,scale,dscale;
rot=0;
...
let draw = function(){
  ...
  if(line.length){
    ...
    context.beginPath();
    let l = line.slice(linelength*itt);
...
let Pendulum = function( canvas, onSrc ){
